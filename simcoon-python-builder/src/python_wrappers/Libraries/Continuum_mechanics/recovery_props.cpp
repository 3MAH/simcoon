...
py::dict check_symetries(const py::array_t<double> &nL) {
    
    mat L = carma::arr_to_mat(nL);
    int axis = 0;
    string umat_type;
    vec props;
    int maj_sym = 0;
...
py::array_t<double> L_iso_props(const py::array_t<double> &nLt) {

    mat Lt = carma::arr_to_mat(nLt);
...
py::array_t<double> M_iso_props(const py::array_t<double> &nMt) {
    
    mat Mt = carma::arr_to_mat(nMt);
...
py::array_t<double> L_isotrans_props(const py::array_t<double> &nLt, const int &axis) {
...
py::array_t<double> M_isotrans_props(const py::array_t<double> &nMt, const int &axis) {
    mat Mt = carma::arr_to_mat(nMt);
...
py::array_t<double> L_cubic_props(const py::array_t<double> &nLt) {
...
py::array_t<double> M_cubic_props(const py::array_t<double> &nMt) {
...
py::array_t<double> L_ortho_props(const py::array_t<double> &nLt) {
...
py::array_t<double> M_ortho_props(const py::array_t<double> &nMt) {
...
py::array_t<double> M_aniso_props(const py::array_t<double> &nMt) {
