...
/*
//This function returns the isochoric principal stretches from V or b, and also the principal vectors and orthogonal projectors
pybind11::tuple isochoric_pstretch(const pybind11::array_t<double> &input, const std::string &input_tensor="V", const double &J=0., const bool &copy=true);

//This function returns the principal stretches from V or b
pybind11::array_t<double> pstretch(const pybind11::array_t<double> &input, const std::string &input_tensor="V", const bool &N_projectors=true, const double &J=0., const bool &copy=true);
...
pybind11::array_t<double> tau_iso_hyper_invariants(const double &dWdI_1_bar, const double &dWdI_2_bar, const pybind11::array_t<double> &b, const double &mJ);

pybind11::array_t<double> sigma_iso_hyper_invariants(const double &dWdI_1_bar, const double &dWdI_2_bar, const pybind11::array_t<double> &b, const double &mJ);

pybind11::array_t<double> tau_vol_hyper(const double &dUdJ, const pybind11::array_t<double> &b, const double &mJ);

pybind11::array_t<double> sigma_vol_hyper(const double &dUdJ, const pybind11::array_t<double> &b, const double &mJ);
