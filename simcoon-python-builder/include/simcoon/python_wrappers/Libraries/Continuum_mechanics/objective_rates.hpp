...
pybind11::array_t<double> A_R(const pybind11::array_t<double> &F, const bool &copy=true);
pybind11::array_t<double> A_F(const pybind11::array_t<double> &F, const bool &copy=true);
