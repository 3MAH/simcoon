...
pybind11::array_t<double> B_R(const pybind11::array_t<double> &F, const bool &copy=true);
pybind11::array_t<double> B_F(const pybind11::array_t<double> &F, const bool &copy=true);
