...
namespace simpy
{
    ...
    double Drucker_stress(const pybind11::array_t<double> &input, const pybind11::array_t<double> &props);

    // This function returns the derivative of the Drucker equivalent stress.
    pybind11::array_t<double> dDrucker_stress(const pybind11::array_t<double> &input, const pybind11::array_t<double> &props, const bool &copy = true);
    ...
    // Provides an anisotropic configurational tensor considering the DFA model
    pybind11::array_t<double> P_DFA(const pybind11::array_t<double> &props, const bool &copy = true);
