...
boost::python::numpy::ndarray L_iso(const double &, const double &, const boost::python::str &);

//Provides the elastic compliance tensor for an isotropic material.
//The two first arguments are a couple of Lamé coefficients. The third argument specify which couple has been provided and the order of coefficients.
//Exhaustive list of possible third argument :
//‘Enu’,’nuE,’Kmu’,’muK’, ‘KG’, ‘GK’, ‘lambdamu’, ‘mulambda’, ‘lambdaG’, ‘Glambda’.
boost::python::numpy::ndarray M_iso(const double &, const double &, const boost::python::str &);

//Returns the elastic stiffness tensor for a cubic material.
//Arguments are the stiffness coefficients C11, C12 and C44.
boost::python::numpy::ndarray L_cubic(const double &, const double &, const double &, const boost::python::str &);

//Returns the elastic compliance tensor for an isotropic material.
//Arguments are the stiffness coefficients C11, C12 and C44.
boost::python::numpy::ndarray M_cubic(const double &, const double &, const double &, const boost::python::str &);
...
boost::python::numpy::ndarray L_ortho(const double &, const double &, const double &, const double &, const double &, const double &, const double &, const double &, const double &, const boost::python::str &);

//Returns the elastic compliance tensor for an orthotropic material.
//Arguments are the stiffness coefficients Cii or E and nu's
boost::python::numpy::ndarray M_ortho(const double &, const double &, const double &, const double &, const double &, const double &, const double &, const double &, const double &, const boost::python::str &);
