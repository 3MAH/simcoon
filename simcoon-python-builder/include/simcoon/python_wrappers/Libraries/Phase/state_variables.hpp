...
//        void rotate_l2g_py(const double&, const double&, const double&);
    
        using simcoon::state_variables::rotate_g2l;
        virtual state_variables_py& rotate_g2l(const state_variables_py&, const double&, const double&, const double&);
};
