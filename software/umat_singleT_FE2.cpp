...
extern "C" void umat_(double *stress, double *statev, double *ddsdde, double &sse, double &spd, double &scd, double &rpl, double *ddsddt, double *drplde, double &drpldt, const double *stran, const double *dstran, const double *time, const double &dtime, const double &temperature, const double &Dtemperature, const double &predef, const double &dpred, char *cmname, const int &ndi, const int &nshr, const int &ntens, const int &nstatev, const double *props, const int &nprops, const double &coords, const double *drot, double &pnewdt, const double &celent, const double *dfgrd0, const double *dfgrd1, const int &noel, const int &npt, const double &layer, const int &kspt, const int &kstep, const int &kinc)
{
    ...
    switch (kstep) {
        ...
        case 1: {
            ...
            smart2abaqus_T_FE2(stress, ddsdde, ddsddt, drplde, drpldt, rpl, statev, ndi, nshr, rve_sv_T->DEtot, rve_sv_T->sigma, rve_sv_T->statev, rve_sv_T->r, rve_sv_T->Wm, rve_sv_T->Wt, rve_sv_T->dSdE, rve_sv_T->dSdT, rve_sv_T->drdE, rve_sv_T->drdT);
            break;
        }
        case 2: {
            for(int i=0 ; i<6 ; i++)
            {
                for(int j=0 ; j<6 ; j++)
                    dSdE(j,i) = statev[i*6+j+7];
            }
            sigma += dSdE*(rve_sv_T->DEtot);
            statev[63] += sum(rve_sv_T->drdE*rve_sv_T->DEtot);
            smart2abaqus_T_FE2(stress, ddsdde, ddsddt, drplde, drpldt, rpl, statev, ndi, nshr, rve_sv_T->DEtot, sigma, rve_sv_T->statev, rve_sv_T->r, rve_sv_T->Wm, rve_sv_T->Wt, dSdE, rve_sv_T->dSdT, rve_sv_T->drdE, rve_sv_T->drdT);
            break;
        }
        case 3: {
            for(int i=0 ; i<6 ; i++)
            ...
            sigma += dSdE*(rve_sv_T->DEtot);
            statev[64] += sum(rve_sv_T->drdE*rve_sv_T->DEtot);
            smart2abaqus_T_FE2(stress, ddsdde, ddsddt, drplde, drpldt, rpl, statev, ndi, nshr, rve_sv_T->DEtot, sigma, rve_sv_T->statev, rve_sv_T->r, rve_sv_T->Wm, rve_sv_T->Wt, dSdE, rve_sv_T->dSdT, rve_sv_T->drdE, rve_sv_T->drdT);
            break;
        }
        case 4: {
            ...
            sigma += dSdE*(rve_sv_T->DEtot);
            statev[65] += sum(rve_sv_T->drdE*rve_sv_T->DEtot);
            smart2abaqus_T_FE2(stress, ddsdde, ddsddt, drplde, drpldt, rpl, statev, ndi, nshr, rve_sv_T->DEtot, sigma, rve_sv_T->statev, rve_sv_T->r, rve_sv_T->Wm, rve_sv_T->Wt, dSdE, rve_sv_T->dSdT, rve_sv_T->drdE, rve_sv_T->drdT);
            break;
        }
        case 5: {
            ...
            sigma += dSdE*(rve_sv_T->DEtot);
            statev[66] += sum(rve_sv_T->drdE*rve_sv_T->DEtot);
            smart2abaqus_T_FE2(stress, ddsdde, ddsddt, drplde, drpldt, rpl, statev, ndi, nshr, rve_sv_T->DEtot, sigma, rve_sv_T->statev, rve_sv_T->r, rve_sv_T->Wm, rve_sv_T->Wt, dSdE, rve_sv_T->dSdT, rve_sv_T->drdE, rve_sv_T->drdT);
            break;
        }
        case 6: {
            ...
            sigma += dSdE*(rve_sv_T->DEtot);
            statev[67] += sum(rve_sv_T->drdE*rve_sv_T->DEtot);
            smart2abaqus_T_FE2(stress, ddsdde, ddsddt, drplde, drpldt, rpl, statev, ndi, nshr, rve_sv_T->DEtot, sigma, rve_sv_T->statev, rve_sv_T->r, rve_sv_T->Wm, rve_sv_T->Wt, dSdE, rve_sv_T->dSdT, rve_sv_T->drdE, rve_sv_T->drdT);
            break;
        }
        case 7: {
            ...
            sigma += dSdE*(rve_sv_T->DEtot);
            statev[68] += sum(rve_sv_T->drdE*rve_sv_T->DEtot);
            smart2abaqus_T_FE2(stress, ddsdde, ddsddt, drplde, drpldt, rpl, statev, ndi, nshr, rve_sv_T->DEtot, sigma, rve_sv_T->statev, rve_sv_T->r, rve_sv_T->Wm, rve_sv_T->Wt, dSdE, rve_sv_T->dSdT, rve_sv_T->drdE, rve_sv_T->drdT);
            break;
        }
        case 8: {
            ...
            sigma += dSdE*(rve_sv_T->DEtot);
            statev[69] += sum(rve_sv_T->drdE*rve_sv_T->DEtot) + sum(rve_sv_T->drdT);
            smart2abaqus_T_FE2(stress, ddsdde, ddsddt, drplde, drpldt, rpl, statev, ndi, nshr, rve_sv_T->DEtot, sigma, rve_sv_T->statev, rve_sv_T->r, rve_sv_T->Wm, rve_sv_T->Wt, dSdE, rve_sv_T->dSdT, rve_sv_T->drdE, rve_sv_T->drdT);
            break;
        }
        default: {
            cout << "Error: The kstep number is outside of the test case :" << endl;
            exit(0);
        }
    }
