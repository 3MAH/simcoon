...
///@brief The elastic UMAT requires 18 constants:
///@brief props(0) : C11
///@brief props(1) : C12
///@brief props(2) : C44
///@brief props(3) : alpha_iso
///@brief props(4) : b      It is the slope that correspond to g
///@brief props(5) : g      the shear strain
///@brief props(6) : Ms     Martensitic start temperature
///@brief props(7) : Af     Austenitic finish temperature
///@brief props(8) : nvariants  The number of martensitic variants
///@brief props(9) : c_lambda0
///@brief props(10) : p0_lambda0
///@brief props(11) : n_lambda0
///@brief props(12) : alpha_lambda0
///@brief props(13) : c_lambda1
///@brief props(14) : p0_lambda1
///@brief props(15) : n_lambda1
///@brief props(16) : alpha_lambda1
...
void umat_sma_mono_cubic(const vec &Etot, const vec &DEtot, vec &sigma, mat &Lt, mat &L, const mat &DR, const int &nprops, const vec &props, const int &nstatev, vec &statev, const double &T, const double &DT, const double &Time, const double &DTime, double &Wm, double &Wm_r, double &Wm_ir, double &Wm_d, const int &ndi, const int &nshr, const bool &start, double &tnew_dt) {
	...
	double Ms = props(6);
	double Af = props(7);
	int nvariants = props(8);
    double c_lambda0 = props(9);
    double p0_lambda0 = props(10);
    double n_lambda0 = props(11);
    double alpha_lambda0 = props(12);
    double c_lambda1 = props(13);
    double p0_lambda1 = props(14);
    double n_lambda1 = props(15);
    double alpha_lambda1 = props(16);
...
/*	if (compteur == maxitNewton_mono) {
        tnew_dt*=0.2;
    }
    else if (compteur <= incNewton_mono ) {	    
		tnew_dt*= 2.;
	}*/
