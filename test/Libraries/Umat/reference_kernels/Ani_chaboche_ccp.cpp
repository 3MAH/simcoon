// REFERENCE ORACLE — verbatim copy of the legacy kernel removed in the
// modular rationalization (last dispatched at commit ccfc803a). Compiled
// ONLY into the Treference_umats test to validate the modular adapters
// against independent physics. Do not modify except to keep it compiling.
