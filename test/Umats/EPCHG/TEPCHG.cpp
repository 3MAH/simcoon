...
///@file TEPCHG.cpp
///@brief Test for generic elastic-plastic user material with configurable yield criterion and Chaboche hardening
///@version 1.0
...
TEST(TEPCHG,EPCHG_solver)
{
    ...
    string path_comparison = "comparison/simul_1.txt";
