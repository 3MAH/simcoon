 ...
 * @brief Thermomechanical generalized Maxwell (Prony series) viscoelastic model with N branches
...
/**
 * @brief Thermomechanical generalized Maxwell (Prony series) viscoelastic model with N branches (``PRONK``, thermomechanical)
 *
 * @details Fully coupled thermomechanical version of umat_prony_Nfast(): the same rheology,
 ...
 * At constant temperature this kernel reproduces umat_prony_Nfast() exactly.
 *
 ...
 * | props[5] | \f$ N \f$ | Number of Maxwell branches | - |
