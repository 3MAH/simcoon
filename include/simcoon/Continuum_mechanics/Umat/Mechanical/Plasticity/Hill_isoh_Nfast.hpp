...
///@file Hill_isoh.hpp
///@brief User subroutine for elastic-plastic materials in 1D-2D-3D case, using a Hill anisotropic criterion
...
void umat_plasticity_hill_isoh_CCP_N(const arma::vec &, const arma::vec &, arma::vec &, arma::mat &, const arma::mat &, const int &, const arma::vec &, const int &, arma::vec &, const double &, const double &,const double &,const double &, double &, double &, double &, double &, const int &, const int &, const bool &, double &);
