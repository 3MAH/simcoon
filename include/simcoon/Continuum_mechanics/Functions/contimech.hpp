 ...
 * @code 
    ...
    d = MIN + (double)(rand()) / ((double)(RAND_MAX/(MAX - MIN)))
    d_MC = Macaulay_p(d);
 * @endcode
*/
 ...
 * @code 
    ...
    double a2 = (double)rand();
    double a3 = (double)rand();
    double c = curvature_ellipsoid(u, v, a1, a2, a3);
 * @endcode
*/
 ...
 * @param sigma_in, u, v, a1, a2, a3
 * @return normal and tangent components of the traction vector (arma::vec)
