...
void write_NonPerio_CDN(const cubic_mesh &, const cubic_mesh &, const std::vector<int> &, const unsigned int &, const unsigned int &, const int & = 4, const double & = 1.0, const std::string & = "data", const std::string & = "CDN_0.inp");
