...
void read_salome_full_mesh(std::vector<section_characteristics> &, std::vector<arma::Col<int> > &, const unsigned int &, const std::string & = "data", const std::string & = "Nsections0.dat", const std::string & = "sc_mesh.dat", const std:: string & = "mesh.dat");
