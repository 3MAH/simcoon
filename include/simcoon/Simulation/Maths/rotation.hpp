...
public:
     ...
     * @return 6x6 stress rotation matrix
     */
     ...
     * @param active If true (default), active rotation; if false, passive
     * @return 6x6 strain rotation matrix
     */
     ...
     * @param active If true (default), active rotation
     * @return Rotated stiffness matrix: voigt_stress * L * voigt_stress^T
     */
     ...
     * @param active If true (default), active rotation
     * @return Rotated compliance matrix: voigt_strain * M * voigt_strain^T
     */
    ...
    /**
     * @brief Apply rotation to a 6x6 strain concentration tensor.
     * @param A 6x6 strain concentration tensor in Voigt notation
     * @param active If true (default), active rotation
     * @return Rotated strain concentration tensor: voigt_strain * A * voigt_stress^T
     */
    arma::mat::fixed<6,6> apply_strain_concentration(const arma::mat::fixed<6,6>& A, bool active = true) const;

    /**
     * @brief Apply rotation to a strain concentration tensor (dynamic size).
     * @param A 6x6 strain concentration tensor
     * @param active If true, active rotation
     * @return Rotated strain concentration tensor
     */
    arma::mat apply_strain_concentration(const arma::mat& A, bool active = true) const;

    /**
     * @brief Apply rotation to a 6x6 stress concentration tensor.
     * @param B 6x6 stress concentration tensor in Voigt notation
     * @param active If true (default), active rotation
     * @return Rotated stress concentration tensor: voigt_stress * B * voigt_strain^T
     */
    arma::mat::fixed<6,6> apply_stress_concentration(const arma::mat::fixed<6,6>& B, bool active = true) const;

    /**
     * @brief Apply rotation to a stress concentration tensor (dynamic size).
     * @param B 6x6 stress concentration tensor
     * @param active If true, active rotation
     * @return Rotated stress concentration tensor
     */
    arma::mat apply_stress_concentration(const arma::mat& B, bool active = true) const;
...
/**
 * @brief Rotates a 6x6 stiffness matrix by an angle around a given axis.
 ...
 */
arma::mat rotate_stiffness(const arma::mat &L, const double &angle, const int &axis, const bool &active = true);
 ...
 * @return The rotated 6x6 stiffness matrix (arma::mat)
 */
arma::mat rotate_stiffness(const arma::mat &L, const arma::mat &R, const bool &active = true);

/**
 * @brief Rotates a 6x6 compliance matrix by an angle around a given axis.
 ...
 */
arma::mat rotate_compliance(const arma::mat &M, const double &angle, const int &axis, const bool &active = true);
 ...
 * @return The rotated 6x6 compliance matrix (arma::mat)
 */
arma::mat rotate_compliance(const arma::mat &M, const arma::mat &R, const bool &active = true);

/**
 * @brief Rotates a 6x6 strain concentration matrix by an angle around a given axis.
 * @param A The 6x6 strain concentration matrix (arma::mat)
 * @param angle The rotation angle in radians (double)
 * @param axis The axis of rotation: 1=x, 2=y, 3=z (int)
 * @param active If true (default), active rotation (bool)
 * @return The rotated 6x6 strain concentration matrix (arma::mat)
 */
arma::mat rotate_strain_concentration(const arma::mat &A, const double &angle, const int &axis, const bool &active = true);

/**
 * @brief Rotates a 6x6 strain concentration matrix using a 3x3 rotation matrix.
 * @param A The 6x6 strain concentration matrix (arma::mat)
 * @param R The 3x3 rotation matrix (arma::mat)
 * @param active If true (default), active rotation (bool)
 * @return The rotated 6x6 strain concentration matrix (arma::mat)
 */
arma::mat rotate_strain_concentration(const arma::mat &A, const arma::mat &R, const bool &active = true);

/**
 * @brief Rotates a 6x6 stress concentration matrix by an angle around a given axis.
 * @param B The 6x6 stress concentration matrix (arma::mat)
 * @param angle The rotation angle in radians (double)
 * @param axis The axis of rotation: 1=x, 2=y, 3=z (int)
 * @param active If true (default), active rotation (bool)
 * @return The rotated 6x6 stress concentration matrix (arma::mat)
 */
arma::mat rotate_stress_concentration(const arma::mat &B, const double &angle, const int &axis, const bool &active = true);

/**
 * @brief Rotates a 6x6 stress concentration matrix using a 3x3 rotation matrix.
 * @param B The 6x6 stress concentration matrix (arma::mat)
 * @param R The 3x3 rotation matrix (arma::mat)
 * @param active If true (default), active rotation (bool)
 * @return The rotated 6x6 stress concentration matrix (arma::mat)
